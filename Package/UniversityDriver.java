...
public class UniversityDriver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Professors salaries: " + prof2.getSalary() + " and " + prof1.getSalary());
        
        System.out.println("Professors sorted from least to greatest: ");
        
        for(Professor profes : prof){
            System.out.println(profes.getSalary());
        }
